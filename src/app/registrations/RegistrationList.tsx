...
export default function RegistrationsList({
	...
	const filtered =
		filter === 'all' ? data : data.filter((r) => r.formType === filter);
	...
	return (
		<div className=" w-full flex flex-col mt-40 p-8 space-y-6 min-h-screen">
			{/* Filter buttons */}
			...
			{session && (
				<button
					...
					className="my-auto w-fit mt-4 bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700 transition"
				>
