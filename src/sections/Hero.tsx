		...
		>
			...
			<div className="relative z-10 h-full flex items-center justify-between text-justify pt-28 mt-0">
				...
				<div className="flex flex-col gap-4 text-white w-2/3 bg-secondary px-12 py-6">
					<h1 className="text-3xl md:text-5xl font-['Nunito'] font-semibold  tracking-wider uppercase text-primary">
						Connecting Communities
					</h1>
					<p className="text-lg md:text-2xl font-medium tracking-wider font-['Inter']">
